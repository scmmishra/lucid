// Code from https://github.com/radix-vue/radix-vue/blob/main/packages/radix-vue/src/shared/useId.ts
 ...
 * @returns either the provided deterministicId if it exists, or a string in the format "lucid-charts-"
...
export function useId(deterministicId?: string) {
  ...
  return deterministicId || `lucid-charts-${count.value}`;
}
